...
export function Header({
  ...
  return (
    <div className="sticky top-0 z-10 bg-[rgba(10,10,10,0.95)] backdrop-blur-[12px] border-b border-white/7 px-5 py-3">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="font-mono text-[11px] text-dimmed mt-2">
